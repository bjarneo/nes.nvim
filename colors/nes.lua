...
-- For more advanced configuration, use: require('nes').setup()

-- Check if the user wants to use the modular system
local ok, nes_colorscheme = pcall(require, "nes")
if ok then
	-- Use the modular system with default configuration
	nes_colorscheme.setup()
	nes_colorscheme.load()
	return
end
