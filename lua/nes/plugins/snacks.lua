-- Snacks.nvim highlights for nes theme
local M = {}
...
function M.apply(colors, config)
	...
	-- Snacks dnesboard
	hl("SnacksDnesboardNormal", { fg = colors.fg, bg = colors.bg })
	hl("SnacksDnesboardDesc", { fg = colors.comment })
	hl("SnacksDnesboardFile", { fg = colors.string })
	hl("SnacksDnesboardDir", { fg = colors.type })
	hl("SnacksDnesboardFooter", { fg = colors.comment })
	hl("SnacksDnesboardHeader", { fg = colors.func, bold = true })
	hl("SnacksDnesboardIcon", { fg = colors.func })
	hl("SnacksDnesboardKey", { fg = colors.keyword })
	hl("SnacksDnesboardTerminal", { fg = colors.fg })
	hl("SnacksDnesboardSpecial", { fg = colors.property })
	hl("SnacksDnesboardTitle", { fg = colors.func, bold = true })
